...
import { Star, Award, Users, ChevronRight, TrendingUp } from '@/utils/ultra-optimized-icons';
...
export const MarketplaceDealershipLink: React.FC<MarketplaceDealershipLinkProps> = ({
  onNavigateToDealershipReviews,
  featuredCount = 0,
}) => {
  const { colors } = useThemeColors();
  ...
  return (
    <TouchableOpacity style={styles.marketplaceLink} onPress={onNavigateToDealershipReviews}>
...
const getStyles = (colors: any, compact: boolean = false) => StyleSheet.create({
  // Regular Container
  container: {
