...
const VirtualCarShowroom: React.FC<VirtualCarShowroomProps> = ({
  ...
  const viewingAngles: ViewingAngle[] = [
    {
      id: 'front',
      name: 'Front View',
      description: 'Classic front perspective',
      icon: '🚗',
    },
    {
      id: 'rear',
      name: 'Rear View',
      description: 'Taillight and exhaust view',
      icon: '🔄',
    },
    {
      id: 'side',
      name: 'Side Profile',
      description: 'Complete side silhouette',
      icon: '📏',
    },
    {
      id: 'interior',
      name: 'Interior',
      description: 'Cabin and dashboard',
      icon: '🪑',
    },
    {
      id: '360',
  ...
  const environments: Environment[] = [
    ...
    },
    {
      id: 'garage',
      name: 'Garage',
      description: 'Home garage setting',
      lighting: 'cool',
      background: '#e9ecef',
    },
    {
    ...
    },
    {
      id: 'racetrack',
      name: 'Racetrack',
      description: 'Performance setting',
      lighting: 'dramatic',
      background: '#495057',
      premium: true,
    },
  ...
  const carFeatures: CarFeature[] = [
    {
      id: 'headlights',
      name: 'LED Headlights',
      description: 'Adaptive LED lighting system',
      type: 'exterior',
      position: [2, 0.5, 0.8],
      highlighted: false,
    },
    {
      id: 'grille',
      name: 'Front Grille',
      description: 'Signature design element',
      type: 'exterior',
      position: [2.2, 0, 0],
      highlighted: false,
    },
    {
      id: 'wheels',
      name: 'Alloy Wheels',
      description: 'Performance wheel design',
      type: 'exterior',
    ...
    },
    {
      id: 'mirrors',
      name: 'Side Mirrors',
      description: 'Heated power mirrors',
      type: 'exterior',
      position: [1, 0.8, 1.5],
      highlighted: false,
    },
    ...
    },
    {
      id: 'engine',
      name: 'Engine',
      description: 'Turbocharged powerplant',
      type: 'performance',
      position: [1.8, 0.3, 0],
      highlighted: false,
    },
  ...
  const handleAngleChange = (angleId: string) => {
    ...
    rotationY.value = withSpring(
      rotations[angleId as keyof typeof rotations] || 0,
    );
  ...
  const handleFeatureHighlight = (featureId: string) => {
    ...
    featureOpacity.value = withTiming(
      highlightedFeature === featureId ? 0.5 : 1,
      {
        duration: 300,
      },
    );
  ...
  const calculateConfigurationPrice = (config: CarConfiguration): number => {
    ...
    return (
      basePrice +
      Object.values(premiums).reduce((sum, premium) => sum + premium, 0)
    );
  };
  ...
  const carAnimatedStyle = useAnimatedStyle(() => ({
    transform: [{ rotateY: `${rotationY.value}rad` }, { scale: scale.value }],
  }));
  ...
  const renderConfigurationPanel = () => (
    <View style={styles.configContainer}>
      <Text style={styles.configTitle}>
        Customize Your {car.make} {car.model}
      </Text>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          {[
            ...
            <TouchableOpacity
              ...
              style={[
                styles.colorOption,
                configuration.exteriorColor === color &&
          ...
          {['Black', 'Tan', 'Gray', 'Red'].map((color) => (
            <TouchableOpacity
              ...
              style={[
                ...
                configuration.interiorColor === color &&
                  styles.interiorOptionActive,
              ]}
  ...
  const renderVirtualDisplay = () => {
    ...
    return (
      <View
        style={[
          styles.virtualDisplay,
          { backgroundColor: currentEnv?.background || '#ffffff' },
        ]}
      >
        <Animated.View style={[styles.carContainer, carAnimatedStyle]}>
          ...
          <View style={styles.carPlaceholder}>
            ...
            <Text style={styles.carViewModeText}>
              {currentAngle.toUpperCase()} VIEW
            </Text>
          </View>
          ...
          {showFeatures && (
            <Animated.View
              style={[styles.featureHotspots, featureAnimatedStyle]}
            >
              {carFeatures.map((feature) => (
                <TouchableOpacity
                  key={feature.id}
                ...
                >
                  ...
                  {highlightedFeature === feature.id && (
                    <View style={styles.featureTooltip}>
                      <Text style={styles.featureTooltipText}>
                        {feature.name}
                      </Text>
                    </View>
                  )}
