...
import { Star, Heart, MessageCircle, CheckCircle, Award, TrendingUp, Clock } from '@/utils/ultra-optimized-icons';
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <View style={styles.userSection}>
          <View style={styles.avatarContainer}>
            <OptimizedImage
              source={{ 
                uri: review.user.avatar || `https://ui-avatars.com/api/?name=${review.user.name}&background=random`
              }}
              style={styles.avatar}
              resizeMode="cover"
            />
      ...
      {review.carDetails && (
        <View style={styles.carDetails}>
          <Text style={[styles.carTitle, { color: colors.text }]}>
            {review.carDetails.year} {review.carDetails.make} {review.carDetails.model}
          </Text>
        </View>
      )}
      ...
      <View style={styles.footer}>
        <View style={styles.actionButtons}>
          <TouchableOpacity 
            style={[styles.actionButton, helpful && styles.actionButtonActive]}
