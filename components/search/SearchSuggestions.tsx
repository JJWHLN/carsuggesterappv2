...
export function SearchSuggestions({
  ...
  const generateSuggestions = useMemo((): SearchSuggestion[] => {
    ...
    const brands = [
      ...
      'Subaru', 'Volvo', 'Lexus', 'Infiniti', 'Acura', 'Genesis',
      'Tesla', 'Peugeot', 'Renault', 'Citroën', 'Fiat', 'Alfa Romeo'
    ];
    ...
    // Model suggestions
    const models = [
      'BMW 3 Series', 'Mercedes C-Class', 'Audi A4', 'VW Golf',
      'Toyota Camry', 'Honda Civic', 'Ford Focus', 'Nissan Altima',
      'Tesla Model 3', 'BMW X5', 'Mercedes GLC', 'Audi Q5'
    ];
    ...
    const categories = [
      ...
      'Electric', 'Hybrid', 'Luxury', 'Sports', 'Family'
    ];
