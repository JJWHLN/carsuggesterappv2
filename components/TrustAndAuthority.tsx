...
import { CheckCircle, Award, Users, Star, TrendingUp, Clock, Zap, AlertTriangle } from '@/utils/ultra-optimized-icons';
...
export const TrustAndAuthority: React.FC<TrustBuildingProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'verification' | 'transparency'>('overview');
  ...
  const credibilityIndicators: CredibilityIndicator[] = [
    ...
    },
    {
      ...
      description: 'Verified partnerships with leading automotive organizations',
      icon: Building,
      status: 'verified',
    ...
    },
    {
      ...
      description: 'All reviews based on actual vehicle testing and dealership visits',
      icon: Camera,
      status: 'verified',
      value: '100% Authentic',
    },
  ...
  const renderTabs = () => (
    <View style={styles.tabContainer}>
      ...
      >
        <CheckCircle color={activeTab === 'verification' ? colors.primary : colors.textSecondary} size={16} />
        <Text style={[
          styles.tabText,
      ...
      >
        <Globe color={activeTab === 'transparency' ? colors.primary : colors.textSecondary} size={16} />
        <Text style={[
          styles.tabText,
    ...
    <View style={styles.section}>
      ...
      <View style={styles.metricsGrid}>
        <View style={styles.metricCard}>
          ...
          <Text style={styles.metricValue}>{trustMetrics.totalReviews.toLocaleString()}</Text>
        ...
        <View style={styles.metricCard}>
          ...
          <Text style={styles.metricValue}>{trustMetrics.industryConnections}</Text>
          <Text style={styles.metricLabel}>Industry Partners</Text>
        </View>

        <View style={styles.metricCard}>
          <Star color={colors.warning} size={20} />
          <Text style={styles.metricValue}>{trustMetrics.userSatisfaction}%</Text>
    ...
    <View style={styles.section}>
      ...
      <View style={styles.expertNetworkCard}>
        <View style={styles.expertNetworkHeader}>
          ...
          <Text style={styles.expertNetworkTitle}>Verified Automotive Experts</Text>
        </View>
        
        <Text style={styles.expertNetworkDescription}>
          Our team consists of certified automotive professionals, former dealership 
          managers, automotive journalists, and industry veterans with combined 
          experience of over 200 years in the automotive sector.
        </Text>

        <View style={styles.expertCategories}>
          <View style={styles.expertCategory}>
            <Target color={colors.primary} size={16} />
            <Text style={styles.expertCategoryText}>ASE Certified Technicians</Text>
          </View>
          
          <View style={styles.expertCategory}>
            <Award color={colors.primary} size={16} />
            <Text style={styles.expertCategoryText}>Former Dealership Managers</Text>
          </View>
          
          <View style={styles.expertCategory}>
            <BookOpen color={colors.primary} size={16} />
            <Text style={styles.expertCategoryText}>Automotive Journalists</Text>
          </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.transparencyCard}>
          ...
          <Text style={styles.transparencyDescription}>
            ...
            any potential conflicts of interest and maintain editorial independence.
          </Text>
        </View>
      </View>
    ...
    return (
      <View style={styles.compactContainer}>
        <View style={styles.compactHeader}>
          ...
          <Text style={styles.compactTitle}>Trusted by {trustMetrics.userSatisfaction}% of users</Text>
        </View>
        <Text style={styles.compactDescription}>
          {trustMetrics.verifiedExperts} verified experts • {trustMetrics.totalReviews.toLocaleString()} reviews
        </Text>
      </View>
    );
  }
