...
export function ContactDealerModal({
  visible,
  onClose,
  car,
  dealerInfo,
  ...
  const contactMethods = [
    {
      ...
      label: 'Phone Call',
      icon: Phone,
      description: 'Get a call from the dealer',
    },
    {
      id: 'email' as const,
      label: 'Email',
      icon: Mail,
      description: 'Receive detailed information via email',
    },
    {
      id: 'text' as const,
      label: 'Text Message',
      icon: MessageCircle,
      description: 'Quick communication via SMS',
    },
    {
      id: 'in_person' as const,
      label: 'Visit Dealership',
      icon: MapPin,
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    isSelected && styles.contactMethodSelected,
                  ]}
                  ...
                  <View style={styles.contactMethodLeft}>
                    <View
                      style={[
                        ...
                        isSelected && styles.contactMethodIconSelected,
                      ]}
                    >
                      <Icon
                    ...
                    <View style={styles.contactMethodText}>
                      <Text
                        style={[
                          ...
                          isSelected && styles.contactMethodLabelSelected,
                        ]}
                      >
                        {method.label}
                      </Text>
          ...
          <View style={styles.section}>
            ...
            >
              <View
                style={[
                  styles.checkbox,
                  interestedInFinancing && styles.checkboxSelected,
                ]}
              >
            ...
            >
              <View
                style={[
                  styles.checkbox,
                  interestedInTrade && styles.checkboxSelected,
                ]}
              >
          ...
          <View style={styles.carSummary}>
            ...
            <Text style={styles.carSummaryPrice}>
