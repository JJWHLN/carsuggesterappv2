...
export const WelcomeScreen = memo<WelcomeScreenProps>(
  ({ onGetStarted, onSignIn, onBrowseAnonymous }) => {
        ...
        >
          ...
          >
            <View style={styles.heroContent}>
              ...
              <View style={styles.logoContainer}>
                <View
                  style={[styles.logoCircle, { backgroundColor: colors.white }]}
                >
              ...
              <View style={styles.heroTextContainer}>
                ...
                <Text style={[styles.heroSubtitle, { color: colors.white }]}>
                  Already browsing? Sign up for AI-powered recommendations and
          ...
          <View style={styles.actionsSection}>
            <Button
              ...
              onPress={() =>
                onBrowseAnonymous ? onBrowseAnonymous() : onGetStarted()
              }
