...
export const RecommendationScreen = memo<RecommendationScreenProps>(
  ({
    ...
    const renderCar: ListRenderItem<CarRecommendation> = useCallback(
      ({ item, index }) => {
            ...
            >
              ...
              >
                ...
                <View style={styles.cardContent}>
                  ...
                  {item.year && (
                    <Text
                      style={[styles.cardYear, { color: colors.textMuted }]}
                    >
                      {item.year}
                    </Text>
                  )}
                ...
                {onFavoriteToggle && (
                  ...
                  >
                    <Heart
                      color={isFavorite ? '#FF4444' : colors.textMuted}
                      size={20}
              ...
              {item.highlightReason && (
                <View
                  style={[
                    styles.highlightReasonContainer,
                    { backgroundColor: colors.primaryLight },
                  ]}
                >
                  <Text
                    style={[styles.highlightReason, { color: colors.primary }]}
                    numberOfLines={1}
                  >
                    ✨ {item.highlightReason}
                  </Text>
      ...
      <View style={styles.header}>
        ...
        >
          <View style={styles.heroContent}>
            ...
            {/* Stats Badge */}
            <View
              style={[styles.statsBadge, { backgroundColor: colors.white }]}
            >
              <Star color={colors.primary} size={16} fill={colors.primary} />
              <Text style={[styles.statsText, { color: colors.primary }]}>
                {cars.length}{' '}
                {cars.length === 1 ? 'perfect match' : 'perfect matches'} found
              </Text>
            </View>
          </View>
        </LinearGradient>
    ...
    const renderEmpty = () => (
      <View style={styles.emptyStateContainer}>
        ...
        >
          ...
          >
            Try adjusting your filters to discover more amazing cars that match
            your preferences
          </Text>
        </LinearGradient>
      </View>
      ...
      >
        <FlatList
          ...
          contentContainerStyle={
            cars.length === 0 ? styles.emptyContent : styles.content
          }
