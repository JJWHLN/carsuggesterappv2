        ...
        {options.map((option) => (
          <TouchableOpacity
            ...
            style={[
              ...
              {
                backgroundColor:
                  value === option.value ? colors.primaryLight : colors.surface,
                borderColor:
      ...
      <View style={styles.sliderContainer}>
        ...
        <View style={styles.stepperContainer}>
          ...
          >
            <Minus
              color={
                (value || min) <= min ? colors.textSecondary : colors.primary
              }
              size={20}
            />
          </TouchableOpacity>
          ...
          >
            <Plus
              color={
                (value || min) >= max ? colors.textSecondary : colors.primary
              }
              size={20}
            />
          </TouchableOpacity>
