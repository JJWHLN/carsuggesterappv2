...
export const PremiumCarCard = memo<PremiumCarCardProps>(({
  ...
  const getDealerBadge = () => {
    if (car.dealer?.verified) {
      return (
        <View style={[styles.dealerBadge, { backgroundColor: colors.success }]}>
          <CheckCircle color={colors.background} size={10} />
          <Text style={[styles.dealerBadgeText, { color: colors.background }]}>
            Verified
          </Text>
        </View>
      );
  ...
  const getConditionBadge = () => {
    ...
    return (
      <View style={[styles.conditionBadge, { backgroundColor: (conditionColors as any)[car.condition] || colors.textMuted }]}>
        <Text style={[styles.conditionBadgeText, { color: colors.background }]}>
          {car.condition}
        </Text>
      </View>
    );
  ...
  const getPricePerformance = () => {
    ...
    return performance === 'above' ? (
      <View style={[styles.priceIndicator, { backgroundColor: colors.success }]}>
        <TrendingUp color={colors.background} size={12} />
        <Text style={[styles.priceIndicatorText, { color: colors.background }]}>
          Great Value
        </Text>
      </View>
    ) : null;
      ...
      >
        ...
        <View style={styles.imageSection}>
          ...
          <View style={styles.viewCount}>
            ...
            <Text style={[styles.viewCountText, { color: colors.background }]}>
              {viewCount}
            </Text>
          </View>
        </View>
            ...
            <View style={styles.compareSection}>
              <TouchableOpacity
                style={[styles.compareButton, { 
                  backgroundColor: isComparing ? colors.primary : colors.primaryLight,
...
const getThemedStyles = (colors: any, variant: string) => StyleSheet.create({
  container: {
