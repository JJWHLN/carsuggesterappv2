...
import { MapPin, Clock, Heart, Star, Fuel, Settings, Eye, MessageCircle } from '@/utils/ultra-optimized-icons';
...
const ModernCarCard = memo<ModernCarCardProps>(({ 
  ...
  }, [user, isBookmarked, car.id, onSaveToggle, loading, announceForAccessibility]);
    ...
    <View style={[styles.container, style]}>
      ...
      <View style={styles.imageContainer}>
        ...
        <View style={styles.imageControls}>
          ...
          {showSaveButton && user && (
            <TouchableOpacity
              style={[styles.floatingButton, isBookmarked && styles.floatingButtonActive]}
        ...
        {car.condition && (
          <View style={styles.conditionBadge}>
            <Text style={styles.conditionText}>{formatCondition(car.condition)}</Text>
          </View>
        )}
      </View>
        ...
        {car.features && car.features.length > 0 && (
          <View style={styles.features}>
            {car.features.slice(0, 3).map((feature, index) => (
              <View key={index} style={[styles.featureTag, { backgroundColor: colors.primaryLight }]}>
