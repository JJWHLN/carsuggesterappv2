...
export const ProfessionalBranding: React.FC<ProfessionalBrandingProps> = ({
  ...
  const [activeCredentialCategory, setActiveCredentialCategory] =
    useState<string>('all');
  ...
  const getCredentialsByCategory = (category: string) => {
    ...
    return currentExpert.credentials.filter(
      (cred) => cred.category === category,
    );
  };
          ...
          <View style={styles.expertInfo}>
            <View style={styles.expertAvatar}>
              {currentExpert.profileImage ? (
                <Image
                  source={{ uri: currentExpert.profileImage }}
        ...
        <View style={styles.socialProofGrid}>
          <View style={styles.proofCard}>
            ...
            <Text style={styles.proofValue}>
              {currentExpert.socialProof.reviewsWritten}
            </Text>
          ...
          <View style={styles.proofCard}>
            ...
            <Text style={styles.proofValue}>
              {(currentExpert.socialProof.helpfulVotes / 1000).toFixed(1)}K+
            </Text>
          ...
          <View style={styles.proofCard}>
            ...
            <Text style={styles.proofValue}>
              {(currentExpert.socialProof.followersCount / 1000).toFixed(1)}K+
            </Text>
          ...
          <View style={styles.proofCard}>
            ...
            <Text style={styles.proofValue}>
              {currentExpert.socialProof.industryConnections}
            </Text>
    ...
    <View style={styles.categoryContainer}>
      <ScrollView horizontal showsHorizontalScrollIndicator={false}>
        <TouchableOpacity
          style={[
            styles.categoryTab,
            activeCredentialCategory === 'all' && styles.activeCategoryTab,
          ]}
          onPress={() => setActiveCredentialCategory('all')}
        >
          <Shield
            color={
              activeCredentialCategory === 'all'
                ? colors.primary
        ...
        {['certification', 'education', 'membership', 'award'].map(
          (category) => {
            ...
            return (
              <TouchableOpacity
                ...
                style={[
                  styles.categoryTab,
                  activeCredentialCategory === category &&
  ...
  const renderCredentials = () => {
    ...
    const filteredCredentials = getCredentialsByCategory(
      activeCredentialCategory,
    );
            ...
            <View key={credential.id} style={styles.credentialCard}>
              ...
              {credential.verificationUrl && (
                <TouchableOpacity
                  ...
                  onPress={() =>
                    openVerificationUrl(credential.verificationUrl!)
                  }
                >
        ...
        <View style={styles.contactCard}>
          ...
          {currentExpert.contactInfo.website && (
            <TouchableOpacity
              ...
              onPress={() =>
                openVerificationUrl(currentExpert.contactInfo!.website!)
              }
            >
    ...
    <View style={styles.compactContainer}>
      ...
      <View style={styles.compactStats}>
        <Text style={styles.compactStat}>
          {currentExpert.yearsExperience}+ years •{' '}
          {currentExpert.socialProof.reviewsWritten} reviews
        </Text>
      </View>
    </View>
  );
