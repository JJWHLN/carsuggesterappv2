...
import { Star, Award, Calendar, User, Clock, TrendingUp, CheckCircle, Eye } from '@/utils/ultra-optimized-icons';
...
export const ExpertReviewCard = memo<ExpertReviewCardProps>(({ 
  ...
  if (isHeadline) {
    return (
      ...
      >
        <OptimizedImage
          source={{ uri: review.image || 'https://via.placeholder.com/400x300?text=No+Image' }}
