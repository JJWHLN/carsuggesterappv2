...
import { Award, CheckCircle, TrendingUp, User, Star, Calendar } from '@/utils/ultra-optimized-icons';
          ...
          <View style={styles.expertInfo}>
            ...
            <View style={styles.expertDetails}>
              ...
              <View style={styles.experienceRow}>
                ...
                <Text style={styles.experience}>{yearsExperience}+ years experience</Text>
              </View>
            </View>
          </View>
