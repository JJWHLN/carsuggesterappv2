...
import { Sparkles, MessageCircle, TrendingUp, Zap, Clock, Trash } from '@/utils/ultra-optimized-icons';
...
export default function AIScreen() {
  ...
  const saveToHistory = async (searchQuery: string) => {
    try {
      ...
      await AsyncStorage.setItem('ai_search_history', JSON.stringify(newHistory));
    } catch (error) {
  ...
  const handleSearchWithAI = useCallback(async (searchQuery: string) => {
    if (!searchQuery.trim()) {
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          <View style={styles.titleContainer}>
            ...
            <Text style={[styles.title, { color: colors.text }]}>AI Car Search</Text>
          </View>
        ...
        <View style={styles.featuresSection}>
          ...
          <View style={styles.featuresGrid}>
            ...
            <View style={[styles.featureCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
              ...
              <Text style={[styles.featureTitle, { color: colors.text }]}>Natural Language</Text>
              <Text style={[styles.featureDescription, { color: colors.textSecondary }]}>
        ...
        <Card style={styles.comingSoonCard}>
          ...
          <Text style={[styles.comingSoonText, { color: colors.textSecondary }]}>
            Advanced AI features including car comparisons, detailed analysis, and personalized buying guides are coming soon!
          </Text>
        </Card>
      </ScrollView>
    </SafeAreaView>
