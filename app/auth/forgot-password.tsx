...
import {
  ...
  SafeAreaView,
  ScrollView,
} from 'react-native'; // Added SafeAreaView and ScrollView
  ...
  const handlePasswordReset = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Error',
        error.message ||
          'An unexpected error occurred while trying to send the reset email.',
      );
    } finally {
      setLoading(false);
    }
...
const styles = StyleSheet.create({
  ...
  container: {
    // Now for ScrollView's contentContainerStyle
    flexGrow: 1,
