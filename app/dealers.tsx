...
export default function DealersScreen() {
  ...
  const dealers: Dealer[] = [
    {
      ...
      description:
        'Specializing in luxury and sports vehicles with over 15 years of experience.',
    ...
    },
    {
      ...
      description:
        'Your trusted partner for reliable family vehicles and eco-friendly options.',
  ...
  const dealerStats = [
    ...
    {
      icon: <Car color={colors.success} size={24} />,
      value: '15,000+',
      label: 'Cars Available',
    },
    {
      icon: <Award color={colors.accentGreen} size={24} />,
      value: '4.7',
      label: 'Avg Rating',
    },
  ];
          ...
          <View style={styles.dealerDetails}>
            ...
            <View style={styles.dealerDetailRow}>
              ...
              <Text style={styles.dealerDetailText}>
                {dealer.inventory} cars available
              </Text>
            </View>
  ...
  const renderDealer: ListRenderItem<Dealer> = useCallback(
    ({ item }) => <DealerCard dealer={item} />,
    [DealerCard],
  );
