...
function AppContent() {
  ...
  useEffect(() => {
    ...
    const inWelcomeFlow =
      segments[0] === 'welcome' || segments[0] === 'preferences';
    const inMainApp =
      segments[0] === '(tabs)' ||
      segments[0] === 'model' ||
      segments[0] === 'car' ||
    ...
    <>
      ...
      >
        ...
        <Stack.Screen
          ...
          options={{ ...commonHeaderStyles, title: 'Recommendations' }}
        />
        ...
        <Stack.Screen
          name="model/[id]"
          options={{ ...commonHeaderStyles, title: 'Model Details' }}
        />
        <Stack.Screen
          name="car/[id]"
          options={{ ...commonHeaderStyles, title: 'Car Details' }}
        />
        <Stack.Screen
          name="brand/[id]"
          options={{ ...commonHeaderStyles, title: 'Brand Details' }}
        />
        <Stack.Screen
          name="review/[id]"
          options={{ ...commonHeaderStyles, title: 'Review Details' }}
        />
        <Stack.Screen
          name="search"
          options={{ ...commonHeaderStyles, title: 'AI Car Search' }}
        />
        ...
        <Stack.Screen
          name="+not-found"
          options={{ ...commonHeaderStyles, title: 'Oops!', headerShown: true }}
        />
      </Stack>
