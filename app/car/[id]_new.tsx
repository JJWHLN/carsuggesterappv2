...
export default function CarDetailScreen() {
  ...
  const specs = [
    ...
    { icon: Users, label: 'Seats', value: '5 seats' },
    {
      icon: Shield,
      label: 'Condition',
      value: formatCondition(car?.condition),
    },
  ];
      ...
      >
              ...
              <View style={styles.heroContent}>
                ...
                <View style={styles.carLocationRating}>
                  <View style={styles.locationContainer}>
                    ...
                    <Text
                      style={[styles.locationText, { color: colors.white }]}
                    >
        ...
        <View style={styles.quickActions}>
          ...
          <Button
            ...
            onPress={() =>
              Alert.alert('Test Drive', 'Test drive scheduling coming soon!')
            }
            variant="outline"
        ...
        <Card style={styles.section}>
          ...
          <View style={styles.sellerInfo}>
            ...
            <View style={styles.sellerDetails}>
              ...
              <Text
                style={[styles.sellerType, { color: colors.textSecondary }]}
              >
                Verified Dealer
              </Text>
        ...
        <Card style={styles.section}>
          ...
          <View style={styles.locationInfo}>
            ...
            <Text style={[styles.locationAddress, { color: colors.text }]}>
              {car.location ||
                'Downtown Auto Center, 123 Main Street, City, State 12345'}
            </Text>
          </View>
        </Card>
