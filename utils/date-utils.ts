 ...
 * Add time to date
 */
export const addTime = (date: Date | string, amount: number, unit: 'minutes' | 'hours' | 'days' | 'weeks'): Date => {
  const d = new Date(date);
...
export const moment = {
  ...
  add: (date: Date | string, amount: number, unit: 'minutes' | 'hours' | 'days' | 'weeks') => 
