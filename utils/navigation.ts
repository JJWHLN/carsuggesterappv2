...
export class NavigationService {
  ...
  static async goToCarComparison(carIds: string[], options: NavigationOptions = {}) {
    if (options.haptic) {
      await Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
    }
  ...
  static async goToDealerReviews(dealerId: string, options: NavigationOptions = {}) {
    if (options.haptic) {
      await Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
    }
   ...
   */
  static async goToSearch(searchParams?: Record<string, any>, options: NavigationOptions = {}) {
    if (options.haptic) {
      await Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
    }
