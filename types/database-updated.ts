...
export interface SponsoredContent {
  id: string;
  sponsor_name: string;
  content_type: 'featured_placement' | 'banner' | 'native_article' | 'comparison_highlight';
...
export interface AffiliateProduct {
  id: string;
  product_name: string;
  product_category: 'insurance' | 'financing' | 'accessories' | 'maintenance' | 'warranties';
...
export type ContentType = 'featured_placement' | 'banner' | 'native_article' | 'comparison_highlight';
export type ProductCategory = 'insurance' | 'financing' | 'accessories' | 'maintenance' | 'warranties';
